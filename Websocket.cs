namespace Websockets
{
    ...
    public static class Utilities
    {
        ...
        /// <returns></returns>
        public static WebSocketClient AcceptWebsocketClient(this WebSocketServer webSocketServer)
        {
            return new WebSocketClient(webSocketServer.Server.AcceptTcpClient());
        }
